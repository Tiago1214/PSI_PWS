...
<head>
     ...
     <link rel="stylesheet" href="./public/FO/css/bootstrap.min.css">
     <link rel="stylesheet" href="./public/FO/css/font-awesome.min.css">
     <link rel="stylesheet" href="./public/FO/css/aos.css">

     <!-- MAIN CSS -->
     <link rel="stylesheet" href="./public/FO/css/tooplate-gymso-style.css">
<!--
...
-->
    ...
    <div class="modal fade" id="membershipForm" tabindex="-1" role="dialog" aria-labelledby="membershipFormLabel" aria-hidden="true">
     ...
     <!-- SCRIPTS -->
     <script src="./public/FO/js/jquery.min.js"></script>
     <script src="./public/FO/js/bootstrap.min.js"></script>
     <script src="./public/FO/js/aos.js"></script>
     <script src="./public/FO/js/smoothscroll.js"></script>
     <script src="./public/FO/js/custom.js"></script>
